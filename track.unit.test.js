...
test('get track liseners per year with wrong track id ', async() => {
    expect(await mockTrack.getTrackListenersPerYear('8u', 2020)).toEqual(0);
})

test('get track liseners per month with wrong track id ', async() => {
    expect(await mockTrack.getTrackListenersPerMonth('8u', 2020, 6)).toEqual(0);
})

test('get track liseners per day with wrong track id ', async() => {
    expect(await mockTrack.getTrackListenersPerDay('8u', 2020, 3, 3)).toEqual(0);
})

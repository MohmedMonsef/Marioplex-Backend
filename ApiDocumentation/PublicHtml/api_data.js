        ...
        "QueryParameters": [
          {
            ...
            "optional": false,
            "field": "country",
            "description": "<p>Optional. A country: an ISO 3166-1 alpha-2 country code.</br> Provide this parameter to ensure that the category exists for a particular country.</p>"
          },
          {
            "group": "QueryParameters",
            "optional": false,
            "field": "locale",
            "description": "<p>Optional. The desired language,</br> consisting of an ISO 639-1 language code and an ISO 3166-1 alpha-2 country code,</br> joined by an underscore. For example: es_MX, meaning &quot;Spanish (Mexico)&quot;.</br> Provide this parameter if you want the category strings returned in a particular language.</br> Note that, if locale is not supplied, or if the specified language is not available,</br> the category strings returned will be in the Spotify default language (American English).</p>"
          }
        ],
        "Response": [
          {
        ...
        "QueryParameters": [
          {
            ...
            "optional": false,
            "field": "country",
            "description": "<p>Optional. A country: an ISO 3166-1 alpha-2 country code.</br> Provide this parameter if you want the list of returned items to be relevant to a particular country.</br> If omitted, the returned items will be relevant to all countries.</p>"
          },
          {
            "group": "QueryParameters",
            "optional": false,
          ...
          },
          {
            ...
            "optional": false,
            "field": "offset",
            "description": "<p>Optional. The index of the first item to return. Default: 0 (the first object). Use with limit to get the next set of items.</p>"
          }
        ],
        "Response": [
          {
        ...
        "BodyParameters": [
          {
            ...
            "optional": false,
            "field": "public",
            "description": "<p>Optional. (Boolean) Defaults to true. If true the playlist will be included in user’s public playlists,</br> if false it will remain private. To be able to follow playlists privately,</br> the user must have granted the playlist-modify-private scope.</p>"
          }
        ],
        "Response": [
          {
        ...
        "Query Paramaters": [
          {
            ...
            "optional": false,
            "field": "uri",
            "description": "<p>Required. The uri of the item to add to the queue. Must be a track or an episode uri.</p>"
          }
        ],
        "Response": [
          {
        ...
        "Query Paramaters": [
          {
            ...
            "optional": false,
            "field": "state",
            "description": "<p>Required.track, context or off.track will repeat the current track.context will repeat the current context.off will turn repeat off.</p>"
          }
        ],
        "Response": [
          {
        ...
        "Body Parameters": [
          {
            ...
            "optional": false,
            "field": "context_uri",
            "description": "<p>Optional. Spotify URI of the context to play. Valid contexts are albums, artists, playlists.</p>"
          },
          {
            "group": "Body Parameters",
            "type": "Array_URIs",
            "optional": false,
            "field": "uris",
            "description": "<p>Optional. A JSON array of the Spotify track URIs to play</p>"
          },
          {
            "group": "Body Parameters",
            "type": "Object",
            "optional": false,
            "field": "offset",
            "description": "<p>Optional. Indicates from where in the context playback should start. Only available when context_uri corresponds to an album or playlist object, or when the uris parameter is used.“position” is zero based and can’t be negative</p>"
          },
          {
            "group": "Body Parameters",
            "type": "integer",
            "optional": false,
            "field": "position_ms",
            "description": "<p>Optional. Indicates from what position to start playback. Must be a positive number. Passing in a position that is greater than the length of the track will cause the player to start playing the next song.</p>"
          }
        ],
        "Response": [
          {

...
module.exports = function(app) {
    ...
    mongoose.connect(process.env.CONNECTION_STRING ? String(process.env.CONNECTION_STRING) : mlab, { useNewUrlParser: true, useCreateIndex: true, useUnifiedTopology: true });

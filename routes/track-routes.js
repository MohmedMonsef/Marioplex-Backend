...
router.get('/tracks/listeners-per-day/:track_id', limiter, async(req, res) => {
    try {
        const trackId = req.params.track_id;
...
router.get('/tracks/listeners-per-month/:track_id', limiter, async(req, res) => {
    try {
        const trackId = req.params.track_id;
        const year = req.query.year;
        const month = req.query.month;
...
router.get('/tracks/listeners-per-year/:track_id', limiter, async(req, res) => {
    try {
        const trackId = req.params.track_id;
        const year = req.query.year;
